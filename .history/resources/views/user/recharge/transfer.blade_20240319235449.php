    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="6" style="white-space: nowrap; color: red;">Nội dung chuyển khoản, bạn ghi rõ:<br>
                <strong>"PTCT - 104768999 - 0949083414"</strong><br><button class="btn btn-secondary btn-copy js-btn-copy"
                    title="Sao chép liên kết" data-clipboard-text="PTct - 104768 - 0949083414"><span
        ...
        <tr>
            ...
            <td style="white-space: nowrap;">VŨ TUẤN ANHN</td>
            <td style="white-space: nowrap;">999999<br><button class="btn btn-secondary btn-copy js-btn-copy"
                    title="Sao chép liên kết" data-clipboard-text="999999"><span class="icon-copy">Sao
                        chép</span></button></td>
            <td style="white-space: nowrap;">TP Cần Thơ</td>
            <!-- <td style="white-space: nowrap; color: red;">PTCT - 104768 - 0949083414</td> -->
        </tr>
