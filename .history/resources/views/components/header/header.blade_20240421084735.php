        ...
        <div class="header-default {{ $container ? $container : '' }} container-header">
            <div class="header-area">
                <div class="user-welcome js-reload-html-header">
                    @if (isset(Auth::user()->ten))
                        <div class="welcome-text">
                            ...
                            <div class="user-history">
                                ...
                                <a href="{{ route('get_user.room.index') }}" class="text-bold text-navigation">Tin
                                    đăng</a>
                    ...
                    @else
                        <a rel="nofollow" class="btn btn-blue" href="{{ route('get.login') }}"><i
                                style="margin-right:10px" class="fa-solid fa-right-to-bracket"></i>Đăng nhập</a>
                        <a rel="nofollow" class="btn btn-blue" href="{{ route('get.register') }}"><i
                                style="margin-right:10px" class="fa-solid fa-user-plus"></i>Đăng ký</a>
                    @endif
                </div>
