...
class ApiPaymentController extends Controller
{
    public function createTransaction(Request $request)
    {
        try {
            ...
            $vnp_TmnCode    = "VPC8UNS5"; //Website ID in VNPAY System
            $vnp_HashSecret = "OSTRMGFFYLKXWHCOIHQBZUDWTOFTJDAU"; //Secret key

            $gateway = Omnipay::create('VNPay');
            $gateway->initialize([
                'vnp_TmnCode' => 'VPC8UNS5',
                'vnp_HashSecret' => 'OSTRMGFFYLKXWHCOIHQBZUDWTOFTJDAU',
            ]);
